...
function safetyNotice() {
  return `<div class="safety"><strong>⚠️ Safety &amp; Privacy Notice</strong><p>Do not enter or submit any personal or sensitive information on this website.</p><ul><li>Never enter your Roblox or Discord password here.</li><li>Never provide payment information, verification codes, authentication codes, or security tokens.</li><li>Never provide your home address, phone number, or other unnecessary personal information.</li><li>Only authenticate through the official Roblox or Discord pages when prompted.</li></ul><p><strong>We will never ask for your Roblox or Discord password.</strong> If you are unsure about a page or request, stop and contact the SIS Activity System administration team.</p></div>`;
}

function sendEntryPage(res) {
  res.statusCode = 200;
  res.setHeader("Content-Type", "text/html; charset=utf-8");
  return res.end(`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>[PS] SIS Activity System</title><style>body{font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:#111;color:#fff;display:grid;place-items:center;min-height:100vh;margin:0;padding:24px;box-sizing:border-box}main{max-width:650px;width:100%;background:#191919;border:1px solid #303030;border-radius:16px;padding:36px;box-sizing:border-box;box-shadow:0 20px 60px rgba(0,0,0,.35)}h1{margin:0 0 10px;font-size:30px}h2{margin:28px 0 10px;font-size:18px}p,li{color:#bdbdbd;line-height:1.6}ul{padding-left:22px}.badge{display:inline-block;color:#fff;background:#2b2b2b;border:1px solid #3b3b3b;border-radius:999px;padding:6px 10px;font-size:13px;margin-bottom:18px}.notice{background:#202020;border-left:3px solid #777;padding:14px 16px;border-radius:8px;margin-top:24px}.safety{background:#302818;border:1px solid #5a4a27;border-left:4px solid #d2ad54;padding:16px 18px;border-radius:10px;margin-top:24px}.safety strong{color:#fff}.safety p,.safety li{color:#d0c6a8}.safety ul{margin:10px 0;padding-left:22px}</style></head><body><main><div class="badge">Blume Corporation</div><h1>[PS] SIS Activity System</h1><p>Secure Roblox account linking for the SIS Activity System.</p><h2>What does this application do?</h2><p>This service allows members to securely associate their Roblox account with their Discord account for SIS Activity System features.</p><h2>Information accessed</h2><ul><li>Roblox User ID</li><li>Roblox username</li><li>Roblox display name</li></ul><p>We do not request or store your Roblox password.</p>${safetyNotice()}<div class="notice"><strong>How to link your account</strong><p>Start the linking process using the <strong>/link</strong> command in the SIS Activity System Discord server.</p></div></main></body></html>`);
}
...
export default async function handler(req, res) {
  try {
    ...
    if (action === "callback") {
      ...
      res.statusCode = 200;
      res.setHeader("Content-Type", "text/html; charset=utf-8");
      return res.end(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Roblox Linked</title><style>body{font-family:system-ui;background:#111;color:#fff;display:grid;place-items:center;min-height:100vh;margin:0;padding:24px}main{text-align:center;max-width:560px;padding:30px}.safety{background:#302818;border:1px solid #5a4a27;border-left:4px solid #d2ad54;padding:16px 18px;border-radius:10px;margin-top:24px;text-align:left}.safety strong{color:#fff}.safety p,.safety li{color:#d0c6a8;line-height:1.6}.safety ul{margin:10px 0;padding-left:22px}</style></head><body><main><h1>Roblox account linked</h1><p>You can return to Discord.</p><p><strong>${escapeHtml(displayName)}</strong> (@${escapeHtml(username)})</p>${safetyNotice()}</main></body></html>`);
    }
